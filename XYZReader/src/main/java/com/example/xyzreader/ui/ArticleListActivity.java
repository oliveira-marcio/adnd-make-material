...
public class ArticleListActivity extends ActionBarActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        int columnCount = getResources().getInteger(R.integer.article_grid_columns);
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public Adapter(Cursor cursor) {
            mCursor = cursor;
            mOffset = getResources().getDimensionPixelSize(R.dimen.offset_y);
        }
        ...
        private void animateViewsIn(View viewToAnimate, int position) {
            if (position > lastPosition) {
                Interpolator interpolator =
                        AnimationUtils.loadInterpolator(ArticleListActivity.this,
